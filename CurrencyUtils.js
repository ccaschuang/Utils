 ...
 *      CurrencyUtils.updateSetting({"precision" : 2, "formatter":CurrencyUtils.TWFormatter, "separateSign": "", "trailingZeros": true });
...
(function () {
	...
	CurrencyUtils.SGFormatter = function (money) {
		if (money.indexOf('-') == 0) { //negative
			return money.substring(1) + "";
		}
		return money;
	...
	CurrencyUtils.format = function (money, setting) {
		...
		money = formatMoney(money, setting.precision, setting.separateSign);
